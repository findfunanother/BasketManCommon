...
class CState_Challenge_OffBallMove_End : public CState_Challenge_OffBallMove
{
public:
	CState_Challenge_OffBallMove_End(CHost* host) : CState_Challenge_OffBallMove(host){}
