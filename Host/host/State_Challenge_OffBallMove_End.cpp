...
void CState_Challenge_OffBallMove_End::OnEnter(void* pData)
{
...
void CState_Challenge_OffBallMove_End::OnUpdate(float timeDelta)
{
...
DHOST_TYPE_BOOL CState_Challenge_OffBallMove_End::OnPacket(CPacketBase* pPacket, void* peer, const DHOST_TYPE_GAME_TIME_F& recv_time)
{
...
const DHOST_TYPE_BOOL CState_Challenge_OffBallMove_End::ConvertPacket_challenge_c2s_retry(DHOST_TYPE_USER_ID userid, void* peer, CFlatBufPacket<F4PACKET::challenge_c2s_retry_data>* pPacket, const DHOST_TYPE_GAME_TIME_F& recv_time)
{
